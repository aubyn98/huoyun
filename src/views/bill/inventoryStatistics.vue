<template>
  <div class="page">
      ...
      <div class="pagecontent-left-box">
        ...
        >
          ...
          <el-table-column label="操作" fixed="right" width="100">
            <template slot-scope="scope">
              <el-button type="primary" @click="go(scope.row.kddh)"
                >查看</el-button
              >
            </template>
          </el-table-column>
              ...
              <div style="display: flex; flex-direction: column">
                ...
                >
                  ...
                  <el-dropdown-menu slot="dropdown" v-if="!$store.state.mobile">
                    <el-dropdown-item
                      @click.native="
                        print('inventory', 'ShowReport', scope.row.kddh)
                      "
                      >预览</el-dropdown-item
                    >
                    <el-dropdown-item
                      @click.native="
                        print('inventory', 'DesignReport', scope.row.kddh)
                      "
                      v-if="
                        $store.state.account &&
    ...
    <div class="pagecontent-bottm">
      ...
      ></el-pagination>
      <div style="pagecontent-bottm-right">
        <el-button
          type="success"
          @click="goinventory"
          v-if="dataType === '列表'"
