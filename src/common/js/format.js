...
import aubyn from 'aubyn-common'
...
export default {
  install(Vue) {
    Vue.prototype.$add = aubyn.math.add
    Vue.prototype.$subtract = aubyn.math.subtract
    Vue.prototype.$divide = aubyn.math.divide
    Vue.prototype.$multiply = aubyn.math.multiply
